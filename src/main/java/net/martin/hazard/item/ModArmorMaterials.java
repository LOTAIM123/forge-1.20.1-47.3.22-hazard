...
public enum ModArmorMaterials implements ArmorMaterial {
    HAZMAT("hazmat", 26,new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () ->Ingredient.of(ModItems.RUBBER.get()));
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound,
                      float thoughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
    ...
    public String getName() {
        return Hazard.MOD_ID + ":" + this.name;
    }
