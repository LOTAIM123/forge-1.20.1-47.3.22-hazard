...
public class HazardDimension {
    ...
    public static void bootstrapType(BootstapContext<DimensionType> context) {
        context.register(HAZARD_DIM_TYPE, new DimensionType(
                ...
                -64, // minY (restored full world height)
                384, // height (restored original height)
                384, // logicalHeight
                BlockTags.INFINIBURN_OVERWORLD, // infiniburn
                BuiltinDimensionTypes.OVERWORLD_EFFECTS, // effectsLocation
                0, // ambientLight
                new DimensionType.MonsterSettings(true, true, ConstantInt.of(7), 7))); // Enabled surface mob spawning
    }
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        LevelStem stem = new LevelStem(dimTypes.getOrThrow(HazardDimension.HAZARD_DIM_TYPE), noiseBasedChunkGenerator);
