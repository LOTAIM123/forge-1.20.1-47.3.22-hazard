...
public class Rad4Biome {
    public static final ResourceKey<Biome> RAD4 = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(Hazard.MOD_ID, "rad4"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(RAD4, rad4(context));
    }

    public static Biome rad4(BootstapContext<Biome> context) {
