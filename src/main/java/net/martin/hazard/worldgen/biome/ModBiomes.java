...
public class ModBiomes {
    public static final ResourceKey<Biome> LVL1_RADIATION = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(Hazard.MOD_ID, "lvl1_radiation"));

    public static void boostrap(BootstapContext<Biome> context) {
        context.register(LVL1_RADIATION, lvl1radiation(context));
    }
    ...
    public static Biome lvl1radiation(BootstapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        ...
                        .skyColor(0x30c918)
                        .grassColorOverride(0xc5c3b6)
                        .foliageColorOverride(0xc5c3b6)
                        .fogColor(0x79ed94)
