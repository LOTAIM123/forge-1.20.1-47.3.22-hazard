...
public class ModParticles {
    public static final DeferredRegister<ParticleType<?>> PARTICLE_TYPES =
            DeferredRegister.create(ForgeRegistries.PARTICLE_TYPES, Hazard.MOD_ID);

    public static final RegistryObject<SimpleParticleType> FLAME_PARTICLES =
            PARTICLE_TYPES.register("flame_particles", () -> new SimpleParticleType(true));
